...
def moderation_page(request):
    ...
    if request.method == 'POST':
        ...
        if name:
            ...
            return redirect('admin-panel:moderate')
    return render(request, 'admin-panel/moderation_page.html', {'total_photos': total_photos,
...
def photo_list(request):
    ...
    return render(request, 'admin-panel/photo_list.html', {'photos': photos})
...
def moderate_photo(request, pk):
    ...
    return render(request, 'admin-panel/moderate_photo.html', {'photo': photo, 'form': form})
...
def user_detail(request, pk):
    try:
        ...
        print(e)
    return render(request, 'admin-panel/detail_user.html', {'user': user})
